public class javaDataSizeRange{
    public static void main(String[] args) {
        ...
        System.out.println("Max Range of Char is  " + Character.MIN_VALUE); // there no output will be appear
        System.out.println("Max Range of Char is  " + Character.MAX_VALUE); // also there no output will be appear
    }
}